...
%% get a specific run to compare / rerun
indicies = string({MetaData.Job}) == 'GvtStudy';
indicies = indicies & string({MetaData.MassConfig}) == MassConfig;
indicies = indicies & string({MetaData.TestType}) == 'rGust';
indicies = indicies & [MetaData.AoA] == 8.6;
indicies = indicies & [MetaData.Velocity] > 18.5;
indicies = indicies & [MetaData.Velocity] < 19.5;
indicies = indicies & ~[MetaData.Locked];
