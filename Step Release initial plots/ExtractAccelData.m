...
%     delta = b(1)-b(i);
%     if delta > 0
%         y(:,i)=[zeros(delta,1);y(1:end-delta,i)]./a(i);
%     elseif delta < 0
%         y(:,i)=[y(1+delta:end,i);zeros(delta,1)]./a(i);
%     end
% end
% 
% figure(5)
...
% l.FontSize = 18;
% t = title('Normalised response of the Wing-tip X accelerometer to a Step Response at multiple speeds');
